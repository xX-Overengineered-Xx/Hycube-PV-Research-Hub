...
Der zentrale Controller ist ein [Chipsee PPC-A8-50-C](https://chipsee.com/product/epca8050c/) Minicomputer ("Controller") mit farbigem 5 Zoll-Display mit Touchscreen. Das ist die flache Kunststoffkiste hinter dem Touchscreen rechts. Darauf läuft ein Embedded-Linux-Betriebssystem auf einem ARM Cortex-A8. 
