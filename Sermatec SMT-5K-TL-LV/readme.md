...
Die Einspeiseleistung des Wechselrichters ist wegen der Schieflastgrenze einphasig auf 4600 VA begrenzt. Deshalb ist die Entladeleistung selbst bei den großen Batteriesätzen auf 4,8 kW begrenzt. 
...
Ersatz: Sermatec baut inzwischen keine Wechselrichter mehr für den Consumer-Bereich, deshalb hat Hycube bei den Tri.aktiv-Geräten auf IMEON gewechselt. Allerdings sind solch kleine (5 kW) Hybridwechselrichter vergleichsweise teuer. Man sollte überlegen, ob man nicht einen so großen dreiphasigen WR beschafft, dass er alle PV-Panels bedienen kann. Damit entfällt der zweite externe WR.

Es gibt eine Kompatibilitätsliste von Pylontech, aber wenn ein WR dort nicht draufsteht, heißt das nur, dass der Hersteller Pylontech nicht für die Prüfung bezahlt hat. Viele aktuelle WR haben mehrere Protokolle eingebaut, darunter das "Pylontech-Protokoll" und können so die vorhandenen Batterien direkt ansprechen. Falls man das System mit eigenem statt Hycube-Controller betreiben will/muss ist die Kompatibilität egal, weil der Controller zwischen WR und Batterie kommunizieren kann.
